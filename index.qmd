...
# Este bloque es solo para mostrar el funcionamiento de un slider Widget de tipo "slider" para seleccionar el año
sliderInput(
   inputId = "anio_slider",
   label = 'Año', 
...
output$tabla <- renderDataTable({
  ...
  # Tabla interactiva
   orquideas_union_area |>
    st_drop_geometry() |>
    select(species, nombre_ac,) |>
    datatable(
    	rownames = FALSE,
      colnames = c("Especie", "Área"),
      options = list(
      	pageLength = 5,
...
output$mapa <- renderLeaflet({
  ...
  addLegend(
    ...
    values = orquideas_union_area$species,
